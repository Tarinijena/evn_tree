                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(child: CommonButton(buttonText: "Environment")),
                        SizedBox(
                          width: 10,
                        ),
                        Expanded(child: CommonButton(buttonText: "Artist"))
                      ],
                    ),
                    SizedBox(
                      height: 30,
              ...
              Column(
                children: [
                  Container(
                    width: MediaQuery.of(context).size.width,
                    //height: 100,
                    decoration: BoxDecoration(color: Color.fromARGB(255, 18, 17, 18)),
                    child: Padding(
                  ...
                  Stack(
                    children: [
                      Container(
                        height: 60,
                        width: 60,
                        decoration: BoxDecoration(borderRadius: BorderRadius.circular(70), color: Colors.black),
                      ),
                      Container(
                          height: 30,
                          width: 30,
                          child: Image(
                            image: NetworkImage("https://cdn-icons-png.flaticon.com/128/733/733585.png"),
                            fit: BoxFit.cover,
                          )),
                    ],
                  ...
                  Stack(
                    children: [
                      ...
                      Container(
                          ...
                          width: 30,
                          child: Image(
                            image: NetworkImage("https://cdn-icons-png.flaticon.com/128/174/174883.png"),
                            fit: BoxFit.cover,
                          )),
                    ],
                    alignment: Alignment.center,
