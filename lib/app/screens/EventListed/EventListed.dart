     ...
     SingleChildScrollView(
          ...
          child: Column(
             children: [
                ...
                Container(
                  child: isSelected==0?_showAllEvent():
                  isSelected==1?_showAllMusic():
                  isSelected==2?_showAllFood():
                  isSelected==3?_showAllTech():null
                  ,
                )
     ...
     GestureDetector(
      ...
      child: Container(
         ...
         decoration: BoxDecoration(
             color:isSelected==index? Color(0xFFB74BFF):Colors.grey.shade400,
              borderRadius: BorderRadius.circular(8)
         ),
         child: Text(name,style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold,color:isSelected==index? Colors.white:Colors.black),),
         ),
    );
                              ...
                              final allEvents=EventData.allEvent[index];
                               return Padding(
                                 ...
                                 child: GestureDetector(
                                  onTap: () {
                                    Navigator.push(context,MaterialPageRoute(builder: (context) =>EventDetails(eventData: allEvents),));
                                  },
                           ...
                           itemBuilder: (context, index) {
                              final allMusic=EventData.music[index];
                               return Padding(
                                 ...
                                 child:GestureDetector(
                                  onTap: () {
                                    Navigator.push(context,MaterialPageRoute(builder: (context) =>EventDetails(eventData: allMusic),));
                                  },
                           ...
                           itemBuilder: (context, index) {
                              final allFood=EventData.food[index];
                               return Padding(
                                 ...
                                 child: GestureDetector(
                                  onTap: () {
                                     Navigator.push(context,MaterialPageRoute(builder: (context) =>EventDetails(eventData: allFood),));
                                  },
                           ...
                           itemBuilder: (context, index) {
                              final allTech=EventData.tech[index];
                               return Padding(
                                 ...
                                 child: GestureDetector(
                                  onTap: () {
                                    Navigator.push(context,MaterialPageRoute(builder: (context) =>EventDetails(eventData: allTech),));
                                  },
