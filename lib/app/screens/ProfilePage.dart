          ...
          body: SingleChildScrollView(
            ...
            Positioned(
              ...
              child:Image.asset("assets/logo1.png")
                 ...
                 SizedBox(height: 50,), 
                 Text("Tarini Kumar Jena",style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold,color: Colors.white),),
                 SizedBox(height: 10,),
                 Padding(
                     ...
                     children: [
                      ...
                      SizedBox(height: 5,),
                       CustomTextField(
                                         ...
                                         Text("Website",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,color: Colors.white),),
                      SizedBox(height: 5,),
                       CustomTextField(
                                         ...
                                         Text("BioData",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,color: Colors.white),),
                      SizedBox(height: 5,),
                       CustomTextField(
    ...
    return Stack(
      ...
      children: [
        ...
        Positioned(
          ...
          child: CircleAvatar(
            radius: 50,
            backgroundImage: NetworkImage('https://tse2.mm.bing.net/th?id=OIP.90o6OQ7-jGqViljHVhhfmQHaE8&pid=Api&P=0&h=220'), // Replace with your image URL
          ),
        ),
      ],
    );
